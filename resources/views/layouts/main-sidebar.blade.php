        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('show_classes')}}">{{trans('main_trans.List_classes')}}</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('show_groups')}}">{{trans('main_trans.Grades_list')}}</a></li>
                    ...
                    <li>
                        ...
                        <li><a href="{{route('create_admins')}}">{{trans('main_trans.add_teacher')}}</a></li>
                        <li><a href="{{route('show_admins')}}">{{trans('main_trans.list_teachers')}}</a></li>
                        </ul>
                    </li>
                     ...
                     <!-- students-->
                       <li>
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('create_students')}}">{{trans('main_trans.add_student')}} </a> </li>
                            <li> <a href="{{route('show_students')}}">{{trans('main_trans.list_students')}} </a> </li>
                        </ul>
                    </li>
