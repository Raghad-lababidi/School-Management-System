...
*/
    ...
    Route::group(['prefix' => 'student'], function () {
        ...
        // Route::get('justifications/{attendance_check_id}', [App\Http\Controllers\User\JustificationController::class, 'showJustification'])->middleware(['auth:sanctum', 'abilities:student-api']);
